...
public abstract class MoveMobToBlockGoal extends Goal {
    ...
    public MoveMobToBlockGoal(MobEntity p_i45888_1_, double p_i45888_2_, int p_i45888_4_) {
        this(p_i45888_1_, p_i45888_2_, p_i45888_4_, 1);
    }

    public MoveMobToBlockGoal(MobEntity p_i48796_1_, double p_i48796_2_, int p_i48796_4_, int p_i48796_5_) {
    ...
    protected int nextStartTick(MobEntity p_203109_1_) {
